...
Fl_Widget *Fl_Scroll_Tabs::push() const {return value_;}
...
void Fl_Scroll_Tabs::draw(){
    ...
    fl_draw_box(FL_UP_FRAME, x(),        y(), button_width_, tab_height_, color());
    fl_draw_box(FL_UP_FRAME, x()+w()-button_width_, y(), button_width_, tab_height_, color());
    ...
    {
        // Save the previous font setup and set our own for the tab labels
        const int prev_font = fl_font(), prev_size = fl_size(); 
        ...
        // Replace the previous font settings
